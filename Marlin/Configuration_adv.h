...
#define SDIO_CLOCK                           4500000 //Malderin
 ...
 */
#define PWM_MOTOR_CURRENT { 550, 550, 600 }          // Values in milliamps
...
//
  ...
  #define TFT_MARLINUI_COLOR 0x0F0F // GREEN
...
#define CUSTOM_USER_MENUS
  ...
  //#define CUSTOM_USER_MENU_TITLE "Меню пользователя"
  //#define USER_SCRIPT_DONE "M117 Команда выполнена"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Оси домой"
  ...
  #define USER_DESC_2 "Оси Х30 Y60"
  #define USER_GCODE_2 "G28 X0 Y0\nG1 X30 Y60.1 F4000"
  #define USER_DESC_3 "Точность 3DTouch"
  #define USER_GCODE_3 "G28 X0 Y0 Z0\nM48 P10 X90 Y90 L3 V4"
#endif
